...
public class OwnerRepository : OwnerRepositoryInterface
{
    private readonly InfrastructureDbContext _context;
    private readonly ILogger _logger;

    public OwnerRepository(InfrastructureDbContext context, ILogger logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    public async Task<bool> IsExistAsync(Guid ownerId)
    {
        return await _context
            .Owners
            .AnyAsync
