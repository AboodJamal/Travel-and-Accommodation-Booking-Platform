...
public class ReviewRepository : ReviewRepositoryInterface
{
    private readonly InfrastructureDbContext _context;
    private readonly ILogger<ReviewRepository> _logger;

    public ReviewRepository(InfrastructureDbContext context, ILogger<ReviewRepository> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    public async Task<bool> HasBookingReviewAsync(Guid bookingId)
    {
        return await _context
            .Reviews
            .AnyAsync
